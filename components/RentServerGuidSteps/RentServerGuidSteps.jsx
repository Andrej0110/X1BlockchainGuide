...
const RentServerGuidSteps = ({ language }) => {
		...
		<div className="">
			...
			<p className="ml-4">In der Dokumentation von der{' '}
				<a href="https://docs.x1.xyz/validating/performance/hardware-requirements" 
					className="text-blue-600 hover:text-blue-800 underline hover:underline-offset-4 transition-colors duration-200" target="_blank">
	      ...
	      <RentServerGuidStep_7 language={language}/>
		</div>
	);
}
