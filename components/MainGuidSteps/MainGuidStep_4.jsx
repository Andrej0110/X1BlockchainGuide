...
const MainGuidStep_4 = ({ id, language }) => {
  return (
    ...
    <p className="ml-4">Wir fangen nun damit an, die X1 Console von {' '} 
      ...
      {' '}zu kopieren. Kleiner Tipp: Einfügen kannst du entweder mit einem Klick der rechten Maustaste oder mit Shift+einfg. </p>
      ...
      <p className="ml-4">2. Sobald die Kopie erstellt ist, kannst du die X1 Console mit dem folgenden Befehl auf deinem Server installieren:</p>
      <p className="ml-4">./x1console.sh</p>
      <p className="ml-4">3. Es dauert ca. 30 Sekunden, bis du nach dem Passwort gefragt wirst. Gib das Passwort ein, das du festgelegt hattest, um auf den Server zuzugreifen.</p>
      ...
      <p className="ml-4">Hin und wieder erscheint ein rosafarbener Bildschirm. In so einem Fall drücke einfach die Taste Enter.</p>
      ...
      <p className="ml-4">1. Solltest du mal den Zugang zum Server verlieren, dann verlierst du auch den Zugang zu deiner Wallet. Um das zu vermeiden, notiere dir die Seed Phrase jeder einzelnen Wallet – in Summe 4 Stück. Solltest du in deinem Terminalfenster, wie ich, nur 2 Wallets sehen, scrolle dann einfach hoch. Die Adresse 'pubkey' musst du nicht händisch abschreiben, weil du diese in der X1 Console jederzeit wiederfinden kannst.</p>
      <p className="ml-4">2. Sobald du dir deine Seed-Phrasen zu den jeweiligen Wallets notiert hast, benötigt deine 'id' Wallet XNT. Gehe hierzu auf die <a href="https://faucet.testnet.x1.xyz/" className="text-blue-600 hover:text-blue-800  hover:underline transition-colors duration-200" target="_blank">Faucet-Webseite</a>.</p>
      <p className="ml-4">Sollte das Faucet leer sein, gibt es noch die Option, in der <a href="https://t.me/+yT0VAcNPFqM3OGQ0" className="text-blue-600 hover:text-blue-800  hover:underline transition-colors duration-200" target="_blank">Validator Telegram Gruppe</a> darum zu bitten, dass dir XNT zugesendet wird. Schreibe hierzu einfach in den Chat deine Pubkey/Adresse von der ID Wallet und bitte um XNT.</p>
      <p className="ml-4">Alternativ kannst du mich auch direkt kontaktieren in der Telegram-Gruppe <a href="https://t.me/X1BlockchainGuide" className="text-blue-600 hover:text-blue-800  hover:underline transition-colors duration-200" target="_blank">X1BlockchainGuide</a>.</p>
      <p className="ml-4">Drücke die Taste Enter und fahre mit der Installation fort. Die Installation kannst du auch ohne XNT abschließen.</p>
      <img src={Validator10} alt={`Test1`} className="mt-4 w-[900px] h-auto rounded-md shadow-sm"  />
      <p className="ml-4">Sobald die Installation abgeschlossen ist, müssen wir die PATH-Änderungen durchführen. Hierzu beenden wir das dargestellte Menü und die X1 Console.</p>
      ...
      <p className="ml-4">2. Wir können nun die X1 Console wieder mit dem folgenden Befehl im Terminal öffnen:</p>
      <p className="ml-4">./x1console.sh</p>
      <p className="ml-4">Wenn du den Schritt nicht übersprungen hast, dir XNT vom Faucet zu besorgen oder über Telegram, dann sollte bei dir der Status 'Active' sein.</p>
      ...
      <p className="ml-4">Wenn dein Status 'Delinquent' ist, dann benötigt deine ID Wallet mindestens 2 XNT. Ob du beriets die XNT vom Faucet oder einem User erhalten hast, kannst du unter '3. Check Balance' nachschauen.</p>
      <p className="ml-4">1. Sobald dir die XNT zur Verfügung stehen, wähle 'Health Check and Start Validator' aus. Nach dem Health Check sollte dein Validator den Status 'Active' haben.</p>
      ...
      <h2 className="ml-4">Solltest du das Terminal schließen, kannst du nach dem Login auf deinen Server mit dem folgenden Befehl auf die X1 Console zugreifen:</h2>
      <DonateButton />
    </div>
  );
};
