...
const MainGuidStep_3 = ({ id, language }) => {
  return (
    <div id={id} className="">
      ...
      />
      <p className="ml-4">Zuerst müssen wir uns mit dem Benutzernamen 'root' anmelden, um einen neuen Benutzernamen anlegen zu können. Wenn du der Schritt für Schritt Anleitung gefolgt bist unter "Server mieten", dann gib das Passwort ein, das du bei InterServer festgelegt hattest. Beachte bei der Eingabe in PuTTY, dass dir die Eingabe vom Passwort nicht angezeigt wird! Tippe das Passwort ein und drücke Enter.</p>
      <img src={PuttyAddUser02} className="mt-4 w-[600px] h-auto rounded-md shadow-sm" />
      <p className="ml-4">Sobald wir uns auf den Server eingeloogt haben, legen wir einen neuen Benutzer an. Im Beispiel lege ich den Benutzer "test" an. Unter diesem Benutzer werden wir in Schritt 4 den Validator einrichten.</p>
      <p className="ml-4">1. Verwende hierzu den Befehl: adduser test</p>
      ...
      <p className="ml-4">3. usermod -aG wheel test</p>
      <p className="ml-4">Mit Enter bestätigen. Anschließend entweder PuTTY schließen oder exit eingeben.</p>
      ...
      <p className="ml-4">Logge dich ein mit dem neuen Benutzernamen ein.</p>
